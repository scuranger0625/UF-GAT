...
while start_idx < total_samples:
    ...
    precision_val = precision_score(y_true_np, best_pred_label)
    recall_val = recall_score(y_true_np, best_pred_label)
    ...
    plt.title(f"ROC Curve (Batch {start_idx//BATCH_SIZE+1})")
...
precision_val = precision_score(all_y_true, best_pred_label)
recall_val = recall_score(all_y_true, best_pred_label)
